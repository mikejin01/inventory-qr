...
const Activity = ({item}) => {
	...
	useEffect( async () => {
		...
		const products_res = await axios.get(
            "https://inventory-qr-api.herokuapp.com/api/products/find/"+item.productID
        );
	...
	*/
	...
	return(
		<Container 
			style={ product.type == "part" ? spanStyles : null} 
		>	
			<Title>
			{ product.type == "part" 
				? null 
				: <Image src={product.img} style={{ width: "100px", height: "100px", justifyContent: "center" }} />
			}
